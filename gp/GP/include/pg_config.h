...
#define PACKAGE_STRING "PostgreSQL 9.6beta1"

/* Define to the version of this package. */
#define PACKAGE_VERSION "9.6beta1"
...
#define PG_VERSION_STR "PostgreSQL 9.6beta1, compiled by Visual C++ build " __STRINGIFY2(_MSC_VER) ", 64-bit"
